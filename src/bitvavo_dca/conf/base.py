...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", "bitvavo_dca"),
        "USER": config("DB_USER", "bitvavo_dca"),
        "PASSWORD": config("DB_PASSWORD", "bitvavo_dca"),
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "bitvavo_dca.utils.context_processors.settings",
            ],
...
WSGI_APPLICATION = "bitvavo_dca.wsgi.application"
...
DEFAULT_FROM_EMAIL = "bitvavo_dca@example.com"
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": LOGGING_DIR / "bitvavo_dca.log",
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
...
AUTHENTICATION_BACKENDS = [
    ...
    "bitvavo_dca.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
]

SESSION_COOKIE_NAME = "bitvavo_dca_sessionid"
...
CSRF_FAILURE_VIEW = "bitvavo_dca.accounts.views.csrf_failure"
...
ADMIN_INDEX_DISPLAY_DROP_DOWN_MENU_CONDITION_FUNCTION = (
    "bitvavo_dca.utils.django_two_factor_auth.should_display_dropdown_menu"
)
...
ELASTIC_APM = {
    "SERVICE_NAME": f"bitvavo_dca {ENVIRONMENT}",
