...
os.environ.setdefault(
    "SECRET_KEY",
    "django-insecure-)k-)7g1b#7zi$7aq8-c5ycb##z)ig$2gfujzi)7a&w@xwt0x)i",
)
os.environ.setdefault("IS_HTTPS", "no")
os.environ.setdefault("VERSION_TAG", "dev")

os.environ.setdefault("DB_NAME", "bitvavo_dca"),
os.environ.setdefault("DB_USER", "bitvavo_dca"),
os.environ.setdefault("DB_PASSWORD", "bitvavo_dca"),
