...
COPY --from=frontend-build /app/src/bitvavo_dca/static /app/src/bitvavo_dca/static
...
ENV RELEASE=${RELEASE} \
    GIT_SHA=${COMMIT_HASH} \
    PYTHONUNBUFFERED=1 \
    DJANGO_SETTINGS_MODULE=bitvavo_dca.conf.docker

ARG SECRET_KEY=dummy

LABEL org.label-schema.vcs-ref=$COMMIT_HASH \
      org.label-schema.vcs-url="https://bitbucket.org/maykinmedia/bitvavo_dca" \
      org.label-schema.version=$RELEASE \
      org.label-schema.name="bitvavo_dca"
